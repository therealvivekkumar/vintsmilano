  ...
  return (
    <nav
      className={`fixed top-0 w-full z-[200] transition-all duration-500 border-b border-transparent ${
        scrolled ? "bg-background/95 backdrop-blur-md border-border/50 py-3 shadow-sm" : "bg-transparent py-6"
      }`}
    >
      <div className="container mx-auto px-6 lg:px-12 relative flex items-center justify-between">
        ...
        <a href="/" onClick={handleLogoClick} className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center" aria-label="Go to home">
          <img
